...
$router->get('/forgotpassword', 'controllers/register/forgotpassword.php')->only('guest');
$router->get('/sendpass-reset', 'controllers/register/sendpass-reset.php')->only('guest');

$router->post('/translatemessage', 'controllers/chats/translate.php')->only('auth');
